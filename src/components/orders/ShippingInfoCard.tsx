...
export const ShippingInfoCard: React.FC<Props> = ({ order, isDark: _isDark, variant = 'client' }) => {
  ...
  // Client variant - Rich & Balanced
  return (
    <div className="h-full flex flex-col justify-between p-4 sm:p-5 rounded-2xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/[0.04] dark:border-white/[0.06] space-y-3">
      <div className="space-y-2.5">
        ...
        <div>
          ...
          <p className="text-slate-700 dark:text-slate-200 leading-relaxed text-xs font-normal mt-0.5">
