...
import { Instagram, Facebook, Youtube, MapPin, Clock, ExternalLink } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-14 border-b ${
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <p className={`text-xs max-w-sm font-normal leading-relaxed ${
              isDark ? 'text-[#86868b]' : 'text-[#515154]'
            }`}>
              Evidência Calçados — Tradição, qualidade e inovação para acompanhar você em todos os momentos do seu dia a dia.
            </p>
          ...
          <div className="space-y-3.5">
            <h4 className={`font-semibold tracking-tight text-xs uppercase ${
            ...
            <ul className={`space-y-2.5 font-normal ${
              ...
              <li>
                <button onClick={() => setCurrentView('about')} className={`transition-colors cursor-pointer text-left ${isDark ? 'hover:text-white' : 'hover:text-black'}`}>
                  Sobre nós
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => setCurrentView('support')} className={`transition-colors cursor-pointer text-left ${isDark ? 'hover:text-white' : 'hover:text-black'}`}>
                  Trabalhe conosco
                </button>
              </li>
              <li>
          ...
          <div className="space-y-3.5 lg:col-span-2">
            <h4 className={`font-semibold tracking-tight text-xs uppercase flex items-center space-x-1.5 ${
              isDark ? 'text-white' : 'text-[#1d1d1f]'
            }`}>
            ...
            <div className="space-y-1.5">
              <p className={`font-semibold text-xs ${isDark ? 'text-slate-200' : 'text-[#1d1d1f]'}`}>
                Evidência Calçados — Centro
              </p>
              <p className={`font-normal text-xs leading-relaxed ${isDark ? 'text-[#86868b]' : 'text-[#515154]'}`}>
            ...
            <div className={`mt-3 rounded-2xl overflow-hidden border h-36 relative group transition-all shadow-xs ${
              isDark ? 'border-white/10 bg-[#1d1d1f]' : 'border-black/10 bg-white'
            }`}>
              <iframe
        ...
        <div className={`pt-8 flex flex-col sm:flex-row items-center justify-between font-normal text-[11px] gap-4 ${
          isDark ? 'text-[#86868b]' : 'text-[#86868b]'
        }`}>
          <p>© 2025 Evidência Calçados. Todos os direitos reservados.</p>
          
          <div className="flex items-center space-x-4">
            <button onClick={() => setCurrentView('support')} className={`transition-colors cursor-pointer ${isDark ? 'hover:text-white' : 'hover:text-black'}`}>
              Termos de Uso
            </button>
            ...
            <span className={isDark ? 'text-white/10' : 'text-black/10'}>|</span>
            <button onClick={() => setCurrentView('meu-crediario')} className={`transition-colors cursor-pointer ${isDark ? 'hover:text-white' : 'hover:text-black'}`}>
              Crediário Próprio
            </button>
          </div>
        </div>
